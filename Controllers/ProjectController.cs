...
namespace BuffteksWebsite.Controllers
{
    public class ProjectController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProjectID,ProjectName,CompanyContactLastName")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProjectID,ProjectName,CompanyContactLastName")] Project project)
        {
